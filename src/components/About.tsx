...
const About = () => {
  return (
    <section className="pt-24 md:pt-28 pb-14 px-6 md:px-12 lg:px-24 relative bg-[#0a0a0f]">
...
>
  I'm a{" "}
  <span className="text-purple-400 font-semibold">React.js Developer</span>{" "}
  with nearly 2 years of experience building modern, responsive, and user-focused web
  applications. I specialize in creating intuitive frontend experiences while also
  working with APIs, authentication, backend functionality, and databases to build
